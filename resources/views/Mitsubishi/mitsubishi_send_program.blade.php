                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                for (var i = 0; i < response.results.length; i++) {
                                    ...
                                    del2 = $('<button type="button" class="btn-sm del_send border-danger" style="font-family: Tahoma;font-size: x-small;text-align: center;width: 100%;border-radius: 6px">حذف1</button>').attr('id', response.results[i]['ID_T'] + 2000).on('click',function () {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (response) {
                                                ...
                                                for (var i = 0; i < response.results.length; i++) {
                                                    ...
                                                    del2 = $('<button type="button" class="btn-sm del_send border-danger" style="font-family: Tahoma;font-size: x-small;text-align: center;width: 100%;border-radius: 6px">حذف1</button>').attr('id', response.results[i]['ID_SUB'] + 3000).on('click',function () {

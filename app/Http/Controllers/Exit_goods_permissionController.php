...
class Exit_goods_permissionController extends Controller
{
    ...
    public function editform(Request $request)
    {
        ...
        $id_form=$request->input('id_form2');
        $description1=$request->input('description2');
        ...
        $origin_destination=$request->input('origin_destination');
        $exit_no=$request->input('exit_no');
        Exit_goods_permission::where('id_exit', $id_exit)->update(['description'=>$description1,'reason4'=>$description2,'exit_no'=>$exit_no,'jamdari_no'=>$jamdari_no,'with_return'=>$with_return,'id_goods_type'=>$id_goods_type,'origin_destination'=>$origin_destination]);
